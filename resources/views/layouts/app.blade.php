            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
						...
						<li class="nav-item">
                            <a href="{{ url('/boxes') }}" class="nav-link"><i class="fab fa-laravel text-info"></i> Boxes</a> 
                        </li>
						<li class="nav-item">
                            <a href="{{ url('/turnos') }}" class="nav-link"><i class="fab fa-laravel text-info"></i> Turnos</a> 
                        </li>
						<li class="nav-item">
                            <a href="{{ url('/especialidads') }}" class="nav-link"><i class="fab fa-laravel text-info"></i> Especialidad</a> 
                        </li>
						<li class="nav-item">
